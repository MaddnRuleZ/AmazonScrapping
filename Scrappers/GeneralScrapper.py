...
class GeneralScrapper:
    ...
    def start_browser_instance(self):
        ...
        chrome_options.add_argument("user-data-dir=/root/Scrapper/ChromeProfile")
        ...
        try:
            ...
            try:
                ...
                WebDriverWait(self.driver, page_load_timeout).until(EC.presence_of_element_located((By.TAG_NAME, "body")))
